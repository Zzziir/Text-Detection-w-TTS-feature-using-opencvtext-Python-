...
__all__ = [
    ...
    'SpeechAudioFormatGUIDText', 'SPEI_REQUEST_UI', 'DISPID_SGRId',
    'DISPID_SpeechPhraseElements', 'DISPID_SPAs_NewEnum',
    'DISPID_SRCResume', 'SpeechCategoryAudioOut', 'SPRST_ACTIVE',
    'DISPID_SpeechGrammarRuleState', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpPhraseInfoBuilder', 'DISPID_SRGDictationUnload',
    'SpeechRecoProfileProperties', 'SAFTADPCM_8kHzMono',
    'SPPHRASEREPLACEMENT', 'ISpProperties', 'SPAO_RETAIN_AUDIO',
    'SpeechVisemeType', 'DISPID_SRStatus', 'DISPID_SVSRunningState',
    'DISPID_SGRSRule', 'DISPID_SPCPhoneToId', 'SAFTGSM610_11kHzMono',
    'ISpeechGrammarRules', 'SPPS_RESERVED2',
    'DISPID_SRCreateRecoContext', 'DISPID_SOTSetId',
    'SpeechAllElements', 'SRARoot', 'eLEXTYPE_RESERVED4',
    'ISpeechTextSelectionInformation', 'DISPID_SLPType',
    'DISPID_SLGetWords', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPEDisplayText', 'DISPID_SPRText',
    'SpeechDictationTopicSpelling', 'SAFT24kHz8BitMono',
    'SPCT_COMMAND', 'ISpeechAudio', 'SVSFParseSsml',
    'DISPID_SpeechPhraseProperty', 'DISPID_SGRClear',
    'DISPID_SGRSTransitions', 'SITooFast',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_2', 'ISpeechRecoContext',
    'SVP_12', 'eLEXTYPE_PRIVATE7', 'SPCT_SUB_COMMAND',
    'DISPID_SOTCSetId', 'SRSActiveAlways', 'SREAudioLevel',
    'DISPID_SWFESamplesPerSec', 'SPSFunction', 'DISPID_SOTCategory',
    'DISPID_SpeechVoiceEvent', 'SREHypothesis',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechPhraseElement',
    'DISPID_SRRAlternates', 'DISPID_SGRSTNextState',
    'SpeechCategoryRecoProfiles', 'DISPID_SRSCurrentStreamNumber',
    'ISpeechAudioStatus', 'DISPID_SVSpeak', 'DISPID_SPPConfidence',
    'SP_VISEME_12', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SPIElements', 'DISPID_SPIGrammarId',
    'SWPUnknownWordPronounceable', 'DISPID_SRCSetAdaptationData',
    'SPINTERFERENCE_TOOLOUD', 'SGRSTTWord', 'DISPID_SVPause',
    'DISPID_SABufferInfo', 'SREPrivate', 'SPPS_Function',
    'SPCONTEXTSTATE', 'SpeechCategoryAppLexicons', 'SRAExport',
    'SPGS_EXCLUSIVE', 'SPEI_VISEME', 'SRAImport',
    'SpeechAudioProperties', 'DISPID_SPEActualConfidence',
    'SPINTERFERENCE', 'SpStream', 'SPPS_Noncontent', 'SVP_5',
    'DISPID_SPIEngineId', 'DISPID_SOTGetDescription',
    'SPEI_SR_AUDIO_LEVEL', 'SPSERIALIZEDRESULT', 'SECFIgnoreWidth',
    'DISPID_SRCEInterference', 'DISPID_SGRsDynamic',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SpeechAudioBufferInfo',
    'ISpeechRecognizer', 'SpMMAudioOut', 'DISPID_SBSSeek',
    'SREFalseRecognition', 'SLOStatic', 'ISpeechRecoResult',
    'DISPID_SVEPhoneme', 'DISPID_SAFType', 'DISPID_SPRuleConfidence',
    'STSF_AppData', 'DISPID_SFSOpen', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPEsCount', 'SITooQuiet', 'DISPID_SRRSetTextFeedback',
    'DISPID_SpeechDataKey', 'ISpNotifySource',
    'DISPID_SRGCmdSetRuleIdState', 'eLEXTYPE_PRIVATE5',
    'ISpeechBaseStream', 'tagSPTEXTSELECTIONINFO', 'DISPID_SRProfile',
    'ISpeechPhraseReplacement', 'eLEXTYPE_MORPHOLOGY',
    'ISpeechVoiceStatus', 'DISPID_SVAudioOutputStream',
    'SRTAutopause', 'DISPID_SPACommit', 'DISPID_SPPNumberOfElements',
    'SVP_0', 'DISPID_SVSLastBookmark', 'SRAORetainAudio',
    'eLEXTYPE_PRIVATE10', 'SPPHRASEELEMENT',
    'DISPID_SLGetPronunciations', 'ISpeechPhraseElement',
    'SGDSInactive', 'ISpeechObjectToken', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_PRIVATE13',
    'ISpeechXMLRecoResult', 'SPWORDPRONUNCIATIONLIST',
    'SPEI_RESERVED5', 'WAVEFORMATEX', 'ISpMMSysAudio', 'SINone',
    'SPRS_INACTIVE', 'eLEXTYPE_PRIVATE11', 'SAFT22kHz8BitStereo',
    'DISPID_SGRsAdd', 'ISpRecoContext',
    'DISPID_SRSSupportedLanguages', 'SPGRAMMARWORDTYPE',
    'DISPID_SpeechCustomStream', 'SpeechAudioVolume', 'SP_VISEME_6',
    'ISpeechResourceLoader', 'DISPID_SpeechBaseStream',
    'SGDSActiveWithAutoPause', 'SLODynamic', 'Speech_Max_Pron_Length',
    ...
    'ISequentialStream', 'DISPID_SMSSetData', 'SPEI_VOICE_CHANGE',
    'DISPID_SRRecognizer', 'SpCompressedLexicon',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRSAudioStatus',
    'DISPID_SpeechPhraseReplacement', 'SGLexicalNoSpecialChars',
    'DISPID_SPRulesItem', 'SPDKL_LocalMachine',
    'DISPID_SPISaveToMemory', 'SPRULE', 'DISPID_SpeechVoice',
    'SRAONone', 'ISpStreamFormat', 'DISPID_SOTGetAttribute',
    'DISPID_SWFEExtraData', 'SASClosed', 'DISPID_SRCEventInterests',
    'DISPID_SRCEBookmark', 'ISpeechRecoResultDispatch',
    'DISPID_SPPParent', 'STSF_FlagCreate', 'ISpRecoContext2',
    'tagSPPROPERTYINFO', 'ISpeechFileStream', 'SDTReplacement',
    'SVEViseme', 'DISPID_SpeechGrammarRule', 'SAFTADPCM_22kHzStereo',
    'DISPID_SpeechLexicon', 'DISPID_SVSInputWordPosition', 'SASPause',
    'SAFTNoAssignedFormat', 'SpeechRuleState',
    'DISPID_SRCEEnginePrivate', 'SASRun', 'ISpRecoCategory',
    'SPCT_DICTATION', 'SPPS_Noun', 'SpResourceManager', 'SVP_3',
    'DISPID_SGRAddResource', 'SVP_18', 'Speech_StreamPos_RealTime',
    'DISPID_SPIEnginePrivateData', 'SPINTERFERENCE_NONE',
    'SpeechEngineProperties', 'SpeechVoicePriority', 'SVPOver',
    'SAFT44kHz8BitMono', 'SPPHRASERULE', 'SRATopLevel', 'SPPS_LMA',
    'DISPID_SpeechRecoResult', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SVSkip', 'SPVISEMES', 'eLEXTYPE_LETTERTOSOUND', 'STCAll',
    'eLEXTYPE_USER', 'ISpStreamFormatConverter', 'SPPS_RESERVED4',
    'SRTSMLTimeout', 'ISpResourceManager', 'SPSEMANTICFORMAT',
    'DISPID_SDKDeleteKey', 'SWPKnownWordPronounceable',
    'SSTTTextBuffer', 'SPFM_NUM_MODES', 'ISpeechPhraseInfo',
    'SPSNoun', 'SpeechDataKeyLocation', 'SAFT44kHz16BitMono',
    'SRSEDone', 'DISPID_SVRate', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRCEFalseRecognition', 'SECNormalConfidence',
    'DISPID_SpeechLexiconPronunciation', 'SPBO_PAUSE',
    'DISPID_SDKOpenKey', 'SPRST_ACTIVE_ALWAYS', 'SPSInterjection',
    'DISPID_SPEs_NewEnum', 'SPAO_NONE', 'SAFTCCITT_ALaw_44kHzStereo',
    'SECFNoSpecialChars', 'DISPID_SVSVisemeId', 'DISPID_SDKCreateKey',
    'SPEVENT', 'DISPID_SRCERecognition', 'SGSExclusive',
    'SREStreamStart', 'SAFT32kHz8BitMono', 'DISPID_SRCESoundEnd',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SAFT8kHz16BitMono',
    'SpeechTokenValueCLSID', 'SPEI_RESERVED3', 'eLEXTYPE_PRIVATE4',
    'ISpeechObjectTokenCategory', 'ISpeechCustomStream',
    'SpeechAudioFormatType', 'SREStreamEnd', 'DISPID_SVSpeakStream',
    'SpeechGrammarState', 'SPLO_DYNAMIC', 'SVP_8', 'ISpObjectToken',
    'SDTDisplayText', 'DISPID_SMSAMMHandle', 'ISpeechRecoGrammar',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVSpeakCompleteEvent', 'SVP_1',
    'SAFT11kHz16BitMono', 'SPAR_High',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SMSADeviceId',
    'SPPS_Modifier', 'DISPID_SRCState', 'DISPID_SBSWrite',
    'SAFT32kHz16BitStereo', 'SPPS_RESERVED3', 'SVSFUnusedFlags',
    'ISpeechLexiconWords', 'IEnumString', 'SAFT12kHz8BitStereo',
    'SpeechWordPronounceable', 'SPBOOKMARKOPTIONS',
    '_RemotableHandle', 'DISPID_SOTCDefault',
    'SpStreamFormatConverter', 'DISPID_SRGetPropertyNumber',
    'SPRULESTATE', 'ISpVoice', 'SAFT32kHz8BitStereo',
    'SPRST_INACTIVE', 'SPBINARYGRAMMAR', 'DISPID_SAFGuid',
    'SPAUDIOOPTIONS', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SWTDeleted', 'SVEWordBoundary', 'ISpeechPhraseProperty',
    'DISPID_SRGDictationLoad', 'DISPID_SPRulesCount',
    'SAFTADPCM_44kHzMono', 'DISPID_SAEventHandle',
    'DISPID_SRCRequestedUIType', 'SPEI_START_SR_STREAM',
    'SpeechTokenKeyFiles', 'DISPID_SpeechPhraseRule',
    'DISPID_SGRSTs_NewEnum', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SPRNumberOfElements', 'SPVPRI_ALERT',
    'SAFTGSM610_8kHzMono', 'DISPID_SpeechAudioStatus',
    'DISPID_SPRuleChildren', 'SPEI_PHONEME', 'SSFMCreateForWrite',
    'eLEXTYPE_PRIVATE2', 'DISPID_SLWLangId',
    'DISPID_SPEAudioStreamOffset',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPRS_ACTIVE',
    'SpPhoneticAlphabetConverter', 'SINoSignal', 'SPEI_SR_BOOKMARK',
    'ISpPhoneticAlphabetSelection', 'SPRECOSTATE',
    'DISPID_SRGetRecognizers', 'ISpDataKey', 'eLEXTYPE_RESERVED7',
    'ISpXMLRecoResult', 'ISpeechLexiconPronunciation',
    'DISPID_SREmulateRecognition', 'SPFM_CREATE',
    'DISPID_SpeechObjectToken',
    'SpeechPropertyNormalConfidenceThreshold', 'IStream',
    'SpeechGrammarTagUnlimitedDictation',
    'SpeechRegistryLocalMachineRoot', 'SpeechAudioFormatGUIDWave',
    'SPSMF_UPS', 'ISpeechPhraseElements', 'SGPronounciation',
    'SGRSTTRule', 'SITooLoud', 'SPSNotOverriden', 'DISPID_SAStatus',
    'DISPID_SpeechObjectTokens', 'DISPID_SOTIsUISupported',
    'SREPhraseStart', 'DISPID_SVWaitUntilDone', 'SPVPRI_OVER',
    'SAFTNonStandardFormat', 'SPWT_PRONUNCIATION',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCEEndStream',
    'SpeechDiscardType', 'SpeechPropertyResponseSpeed',
    'SPSHORTCUTPAIR', 'DISPID_SVEViseme', 'DISPID_SLWsCount',
    'SpeechGrammarTagDictation', 'DISPID_SVSLastResult',
    'SVEAllEvents', 'DISPID_SpeechGrammarRules', 'SRTStandard',
    'SpAudioFormat', 'SPSModifier', 'eLEXTYPE_PRIVATE18',
    'SPSHT_Unknown', 'SVEPhoneme', 'ISpRecoGrammar2', 'ISpShortcut',
    'DISPID_SASetState', 'DISPID_SGRInitialState',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'eLEXTYPE_VENDORLEXICON', 'SPAS_PAUSE', 'SP_VISEME_18',
    'SP_VISEME_19', 'SSSPTRelativeToEnd', 'SPPS_Interjection',
    'DISPID_SGRsItem', 'SDA_One_Trailing_Space', 'SPEI_MAX_SR',
    ...
    'SPEI_SENTENCE_BOUNDARY', 'SpeechPropertyAdaptationOn',
    'SGSDisabled', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRGState', 'DISPID_SpeechFileStream',
    'SPSEMANTICERRORINFO', 'DISPID_SRGRules',
    '_ISpeechRecoContextEvents', 'DISPID_SGRSTsItem', 'ISpAudio',
    'DISPID_SVResume', 'SpeechRecognizerState', 'STCInprocHandler',
    'SPSVerb', 'DISPIDSPTSI_SelectionOffset', 'SPPS_Verb',
    'SpeechMicTraining', 'DISPID_SpeechPhraseBuilder', 'SPWORD',
    'SpUnCompressedLexicon', 'SPSSuppressWord', 'DISPID_SVEStreamEnd',
    'SPWF_SRENGINE', 'ISpeechMMSysAudio',
    'DISPID_SRGDictationSetState', 'ISpeechPhraseAlternate',
    'ISpPhraseAlt', 'SP_VISEME_17', 'SAFTADPCM_8kHzStereo',
    'ISpObjectWithToken', 'ISpeechLexicon',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SpeechPhoneConverter',
    'DISPID_SRRTTickCount', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SASCurrentSeekPosition', 'SAFTCCITT_ALaw_11kHzMono',
    'SpeechUserTraining', 'SVP_17', 'SPWORDLIST',
    'DISPID_SPCIdToPhone', 'SpMMAudioIn', 'SVP_9', 'SSTTDictation',
    'DISPID_SVSPhonemeId', 'DISPID_SABIBufferSize',
    'SAFTADPCM_44kHzStereo', 'SRERequestUI',
    'DISPID_SRCEPropertyStringChange', 'SRTExtendableParse',
    'SpeechAddRemoveWord', 'SPEVENTSOURCEINFO',
    'SpeechGrammarTagWildcard', 'SP_VISEME_2', 'SSFMCreate',
    'SpNotifyTranslator', 'SpSharedRecoContext',
    'ISpeechPhraseAlternates', 'SVP_10', 'SPWAVEFORMATTYPE',
    'SVF_None', 'DISPID_SDKGetStringValue', 'SAFT44kHz16BitStereo',
    'SRTReSent', 'STSF_CommonAppData', 'SP_VISEME_10',
    'SPRECOGNIZERSTATUS', 'DISPID_SLWs_NewEnum', 'SP_VISEME_20',
    'DISPID_SVStatus', 'SVSFIsNotXML', 'SAFT8kHz16BitStereo',
    'SPVOICESTATUS', 'DISPID_SPIStartTime', 'SPCT_SLEEP',
    'SREBookmark', 'DISPID_SASState', 'SVSFDefault',
    'SAFTCCITT_uLaw_8kHzMono', 'SpSharedRecognizer',
    'SAFT8kHz8BitStereo', 'DISPID_SpeechWaveFormatEx',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPEEngineConfidence',
    'SPPROPERTYINFO', 'SpeechLoadOption', 'DISPIDSPTSI_ActiveOffset',
    'SPDKL_CurrentConfig', 'DISPID_SVEStreamStart',
    'SPEI_RECO_STATE_CHANGE', 'SpeechVoiceSpeakFlags',
    'DISPID_SPRsCount', 'SITooSlow', 'eWORDTYPE_ADDED',
    'DISPID_SBSFormat', 'DISPID_SGRsFindRule', 'ISpGrammarBuilder',
    'STCRemoteServer', 'SPGS_DISABLED', 'SVSFlagsAsync',
    'DISPID_SPIRule', 'DISPID_SASFreeBufferSpace',
    'SAFT22kHz8BitMono', 'ISpPhoneConverter', '__MIDL_IWinTypes_0009',
    'DISPID_SpeechLexiconWords', 'DISPID_SLWsItem', 'SBONone',
    'SRTEmulated', 'SGRSTTWildcard', 'SAFTADPCM_11kHzMono',
    'SPDKL_CurrentUser', 'DISPID_SABIEventBias',
    'DISPID_SRRGetXMLErrorInfo', 'Speech_StreamPos_Asap',
    'SpNullPhoneConverter', 'SRSActive', 'ISpeechRecoResult2',
    'SECFIgnoreKanaType', 'DISPID_SVEVoiceChange',
    'DISPID_SRDisplayUI', 'SP_VISEME_5', 'SP_VISEME_15',
    '_ISpeechVoiceEvents', 'ISpeechLexiconPronunciations',
    'SP_VISEME_13', 'DISPID_SRGIsPronounceable',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPIDSPTSI',
    'DISPID_SVGetAudioOutputs', 'SVEAudioLevel',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPIReplacements',
    'ISpPhrase', 'SpeechEmulationCompareFlags', 'SP_VISEME_16',
    'SVF_Stressed', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SpeechRecoContext', 'SREStateChange', 'SPDATAKEYLOCATION',
    'SPINTERFERENCE_NOSIGNAL', 'SPSTREAMFORMATTYPE',
    'DISPID_SVEEnginePrivate', 'SVP_11',
    'DISPID_SPRuleEngineConfidence', 'SpeechCategoryPhoneConverters',
    'DISPID_SpeechVoiceStatus', 'SAFT12kHz16BitMono',
    'DISPID_SRCAudioInInterferenceStatus', 'SWTAdded', 'SPWT_LEXICAL',
    'DISPID_SDKSetBinaryValue', 'SDTLexicalForm',
    'DISPID_SDKGetlongValue', 'SPEI_TTS_PRIVATE',
    'DISPID_SGRSTPropertyName', 'SDTProperty',
    'DISPID_SRSetPropertyString', 'DISPID_SRRTimes',
    'DISPID_SAVolume', 'SPEI_WORD_BOUNDARY', 'SDTAll',
    'SPPHRASEPROPERTY', 'SPINTERFERENCE_LATENCY_WARNING',
    'SDA_No_Trailing_Space', 'DISPID_SGRSTText', 'DISPID_SVVoice',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPRuleParent', 'SPRST_NUM_STATES',
    'DISPID_SBSRead', 'SpeechGrammarRuleStateTransitionType',
    'SPGRAMMARSTATE', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SPAPhraseInfo', 'SAFT24kHz8BitStereo', 'SPWF_INPUT',
    ...
    'SPEI_END_INPUT_STREAM', 'DISPID_SCSBaseStream',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRCEPhraseStart',
    'DISPID_SOTRemoveStorageFileName', 'UINT_PTR',
    'SpeechRecognitionType', 'DISPID_SVGetProfiles',
    'DISPID_SRRGetXMLResult', 'ISpeechPhraseReplacements', 'SPAS_RUN',
    'DISPID_SFSClose', 'DISPID_SRGetPropertyString', 'SpeechWordType',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRRPhraseInfo',
    'tagSTATSTG', 'ISpNotifyTranslator', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPILanguageId', 'DISPID_SpeechPhraseRules',
    'SpeechTokenShellFolder', 'DISPID_SPEAudioTimeOffset',
    'SRERecognition', 'SAFTExtendedAudioFormat',
    'DISPID_SOTCreateInstance', 'SPPHRASE', 'SGRSTTDictation',
    'DISPID_SMSGetData', 'ISpeechWaveFormatEx', 'eLEXTYPE_PRIVATE12',
    'ISpeechLexiconWord', 'SVP_14', 'SVESentenceBoundary',
    'SpeechVoiceEvents', 'SAFTCCITT_uLaw_22kHzMono', 'SPFILEMODE',
    'SpeechCategoryVoices', 'DISPID_SRRTStreamTime',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRAudioInput',
    'SAFT16kHz8BitMono', 'SpeechRuleAttributes', 'SP_VISEME_3',
    'ISpeechObjectTokens', 'Speech_Default_Weight',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRIsShared',
    'DISPID_SRRDiscardResultInfo', 'SVEBookmark', 'SECHighConfidence',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRSAddRuleTransition',
    'eLEXTYPE_PRIVATE15', 'SpeechCategoryAudioIn', 'ISpStream',
    'SGRSTTEpsilon', 'SPEI_RESERVED2', 'DISPID_SRRSaveToMemory',
    'SBOPause', 'DISPID_SVSInputSentencePosition',
    ...
    'DISPID_SPPValue', 'SPXRO_SML', 'SPSHT_NotOverriden',
    'DISPID_SAFGetWaveFormatEx', 'SRSInactive',
    'SPEI_START_INPUT_STREAM', 'SpMemoryStream',
    'DISPID_SRCEStartStream', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SGRName', 'SPPS_Unknown', 'SRESoundEnd', 'SREAdaptation',
    'SPEI_MAX_TTS', 'eLEXTYPE_PRIVATE19', 'SpeechInterference',
    'DISPID_SPRuleFirstElement', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRRAudioFormat', 'DISPID_SPIAudioStreamPosition',
    'ISpeechAudioFormat', 'SpMMAudioEnum', 'eLEXTYPE_RESERVED8',
    'ISpLexicon', 'SAFTDefault', 'DISPID_SpeechRecognizer',
    'DISPID_SPRuleName', 'SPEI_RESERVED6',
    'DISPID_SpeechGrammarRuleStateTransition',
    'ISpObjectTokenCategory', 'SAFT16kHz16BitMono', 'SPSHORTCUTTYPE',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SOTCGetDataKey',
    'SAFT22kHz16BitStereo', 'SREInterference', 'SAFT16kHz8BitStereo',
    'SPLOADOPTIONS', 'SPBO_NONE', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SGRSTsCount', 'DISPID_SPAStartElementInResult',
    'SAFTText', 'SRCS_Disabled', 'SVEPrivate', 'SPVPRI_NORMAL',
    'DISPID_SRCRetainedAudio', 'SpeechLexiconType', 'ISpRecognizer2',
    'SP_VISEME_9', 'SPSUnknown', 'DISPID_SGRs_NewEnum',
    'DISPID_SPRuleNumberOfElements', 'SPEVENTENUM', 'SP_VISEME_8',
    'DISPID_SRCRecognizer', 'SVP_21',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', '_SPAUDIOSTATE',
    'DISPID_SpeechLexiconWord', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRRRecoContext', 'SPPS_SuppressWord', 'SVSFPersistXML',
    'DISPID_SPRsItem', 'SPCS_ENABLED', 'SAFT11kHz8BitStereo',
    'DISPID_SLWPronunciations', 'SVP_4', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVAlertBoundary', 'ISpRecognizer3',
    'DISPID_SRRSpeakAudio', 'SpeechVisemeFeature',
    'SPINTERFERENCE_NOISE', 'DISPID_SPEPronunciation',
    'DISPID_SGRSTType', 'DISPID_SABufferNotifySize',
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechVoice', 'SAFTADPCM_11kHzStereo',
    'eLEXTYPE_PRIVATE16', 'DISPID_SGRSTWeight', 'SPEI_INTERFERENCE',
    'ISpeechDataKey', 'DISPID_SLPPhoneIds',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRGSetTextSelection',
    'SPRECORESULTTIMES', 'SpeechEngineConfidence',
    'DISPID_SPIProperties', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRRAudio', 'SpeechTokenKeyAttributes', 'SVP_13',
    'DISPID_SOTMatchesAttributes', 'DISPID_SOTCId',
    'ISpeechRecoResultTimes', 'DISPID_SDKDeleteValue',
    'SAFTGSM610_44kHzMono', 'SpObjectToken',
    'DISPID_SpeechRecoResult2', 'DISPID_SLWType', 'SpeechRunState',
    'SPGS_ENABLED', 'DISPID_SDKGetBinaryValue', 'SPBO_TIME_UNITS',
    'IInternetSecurityManager', 'SpeechRetainedAudioOptions',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRState', 'SpeechGrammarWordType', 'eWORDTYPE_DELETED',
    'DISPID_SpeechPhraseProperties', 'SPWT_DISPLAY',
    'DISPID_SRCVoice', 'SPEI_MIN_TTS',
    'DISPID_SRCERecognizerStateChange', 'SPVPRIORITY', 'SP_VISEME_21',
    'SECLowConfidence', 'SVP_15', 'SDKLCurrentUser',
    'DISPID_SpeechAudio', 'DISPID_SpeechAudioFormat', 'SPCS_DISABLED',
    'SAFT8kHz8BitMono', 'SECFDefault', 'DISPID_SOTsCount',
    'DISPID_SPRules_NewEnum', 'DISPID_SRRTLength', 'SPEI_RESERVED1',
    'SAFT16kHz16BitStereo', 'SPPS_RESERVED1', 'SDTAudio',
    'IEnumSpObjectTokens', 'SDA_Two_Trailing_Spaces', 'SVSFParseSapi',
    'DISPID_SPPId', 'SP_VISEME_7', 'eLEXTYPE_PRIVATE17',
    'SPFM_OPEN_READWRITE', 'DISPID_SVDisplayUI',
    'SpeechVoiceCategoryTTSRate', 'SpeechPropertyResourceUsage',
    'DISPID_SPPsItem', 'SLTApp', 'DISPID_SLWWord',
    'SPDKL_DefaultLocation', 'SVPAlert', 'SAFTADPCM_22kHzMono',
    'SPPARTOFSPEECH', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRGCmdLoadFromResource', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SWFEBlockAlign', 'SRSEIsSpeaking', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRGetFormat', 'DISPID_SLPLangId', 'SAFT12kHz8BitMono',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SOTs_NewEnum',
    'SPFM_OPEN_READONLY', 'DISPID_SPPs_NewEnum', 'SVSFVoiceMask',
    'DISPID_SpeechMemoryStream', 'SPEI_TTS_BOOKMARK',
    'DISPID_SVAudioOutput', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SRIsUISupported', 'SpeechTokenContext', 'SpVoice',
    'SP_VISEME_11', 'DISPID_SRGCmdLoadFromFile',
    'SPSMF_SAPI_PROPERTIES', 'ISpRecoResult', 'DISPID_SPPName',
    'SAFT48kHz8BitStereo', 'SINoise', 'SGSEnabled',
    'DISPID_SDKEnumKeys', 'SP_VISEME_1', 'SPWORDTYPE',
    'SpeechStreamFileMode', 'SpeechBookmarkOptions',
    'DISPID_SpeechRecoResultTimes', 'SAFT48kHz16BitStereo',
    'SPLO_STATIC', 'SpeechRecoContextState',
    'IInternetSecurityMgrSite', 'DISPID_SLPPartOfSpeech',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPAsCount',
    'SDKLCurrentConfig', 'SPFM_CREATE_ALWAYS', 'eLEXTYPE_RESERVED9',
    'SVSFIsFilename', 'DISPID_SPIGetText', 'DISPID_SRGRecoContext',
    'SREPropertyStringChange', 'DISPID_SLAddPronunciation',
    'STCInprocServer', 'DISPID_SVEAudioLevel',
    'DISPID_SVESentenceBoundary', 'SpeechRegistryUserRoot',
    'DISPID_SpeechPhraseAlternate', 'SVSFParseMask',
    ...
    'SpeechRecoEvents', 'SVP_6', 'DISPID_SRCCreateGrammar',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SOTDataKey',
    'DISPID_SGRSAddWordTransition', 'SPWORDPRONUNCIATION',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SOTId',
    'SDKLLocalMachine', 'SASStop', 'DISPID_SRCEAdaptation',
    'SPAUDIOBUFFERINFO', 'SPAS_CLOSED', 'DISPID_SVPriority',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_ADAPTATION',
    'SP_VISEME_14', 'ISpNotifySink', 'SRESoundStart',
    'DISPID_SRCEAudioLevel', 'SpeechTokenIdUserLexicon',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPPEngineConfidence', 'DISPID_SRCESoundStart',
    'SDTPronunciation', 'SPAUDIOSTATE', 'SAFTGSM610_22kHzMono',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SGRsCount',
    'SpObjectTokenCategory', 'SAFTCCITT_uLaw_44kHzMono',
    'SSFMOpenReadWrite', 'SPCT_SUB_DICTATION', 'SECFEmulateResult',
    'eLEXTYPE_PRIVATE20', 'SPWORDPRONOUNCEABLE',
    'SVEStartInputStream', 'DISPID_SLGenerationId', 'DISPID_SRGReset',
    'DISPID_SGRsCommitAndSave', 'SPSLMA', 'SPCATEGORYTYPE',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SVVolume',
    'DISPID_SpeechPhraseInfo', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPPChildren', 'DISPID_SVEWord', 'DISPID_SPPFirstElement',
    'SPLEXICONTYPE', 'DISPID_SRAudioInputStream', 'SGLexical',
    'SSTTWildcard', 'ISpeechGrammarRule', 'DISPID_SPAsItem',
    'DISPID_SLPSymbolic', 'SpeechPropertyHighConfidenceThreshold',
    'SpLexicon', 'SpCustomStream', 'DISPID_SPPsCount',
    'DISPID_SLPsCount', 'SGRSTTTextBuffer', 'SPEI_FALSE_RECOGNITION',
    'SVSFNLPSpeakPunc', 'DISPIDSPRG', 'SAFT12kHz16BitStereo',
    'DISPID_SLPs_NewEnum', 'ISpRecoGrammar',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPCLangId',
    'SVF_Emphasis', 'SVEVoiceChange', 'DISPID_SVSInputSentenceLength',
    'SREPropertyNumChange', 'SPPS_NotOverriden', 'SDTRule',
    'DISPID_SpeechMMSysAudio', 'DISPID_SASCurrentDevicePosition',
    'SPBO_AHEAD', 'DISPID_SRGSetWordSequenceData', 'DISPID_SRGId',
    'eLEXTYPE_RESERVED6', 'DISPID_SWFEChannels',
    'DISPID_SWFEFormatTag', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRCEHypothesis', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRCPause', 'SPTEXTSELECTIONINFO', 'SPSHT_OTHER',
    'ISpeechPhraseProperties', 'DISPID_SRGCommit',
    'SpeechVoiceSkipTypeSentence', 'SAFT32kHz16BitMono',
    'SPAR_Medium', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SDKEnumValues', 'eLEXTYPE_APP',
    'DISPID_SRSetPropertyNumber', 'SSSPTRelativeToStart',
    'SPXRO_Alternates_SML', 'DISPID_SPIAudioSizeBytes', 'SVSFIsXML',
    'DISPID_SGRAttributes', 'DISPID_SOTRemove', 'SpInProcRecoContext',
    'DISPID_SDKSetStringValue', 'SVP_16', 'SPADAPTATIONRELEVANCE',
    'SpeechFormatType', 'SPEI_SOUND_END', 'DISPID_SADefaultFormat',
    'SREAllEvents', 'SPEI_MIN_SR', 'SVSFParseAutodetect',
    'DISPID_SRCERequestUI', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPRDisplayAttributes', 'SAFT22kHz16BitMono',
    'SAFT24kHz16BitMono', 'DISPID_SRSClsidEngine',
    'ISpeechAudioBufferInfo', 'DISPID_SPARecoResult',
    'DISPID_SVEBookmark', 'SPEI_HYPOTHESIS', 'ISpEventSource',
    'ISpeechRecognizerStatus', 'SpeechSpecialTransitionType',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPRFirstElement',
    'DISPID_SPERequiredConfidence', 'SPSERIALIZEDPHRASE',
    'DISPID_SPRs_NewEnum', 'DISPID_SRCBookmark', 'SLTUser',
    'ISpRecognizer', 'SAFT44kHz8BitStereo',
    'SpeechStreamSeekPositionType', 'SpTextSelectionInformation',
    'DISPID_SPRuleId', 'SRAInterpreter', 'ISpeechPhraseInfoBuilder',
    'SAFT48kHz16BitMono', 'DISPID_SGRSTRule', 'DISPID_SOTsItem',
    'SVEEndInputStream', 'SP_VISEME_0', 'SPEI_RECOGNITION',
    'DISPID_SASNonBlockingIO', 'ISpPhoneticAlphabetConverter',
    'SpWaveFormatEx', 'SpPhoneConverter', 'SPAUDIOSTATUS',
    'SAFT48kHz8BitMono', 'DISPID_SVSyncronousSpeakTimeout',
    'SPEI_UNDEFINED', 'SAFT24kHz16BitStereo',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpeechTokenKeyUI',
    'DISPID_SDKSetLongValue', 'ISpeechMemoryStream', 'LONG_PTR',
    'ISpeechPhraseRules', 'DISPID_SPEsItem',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SMSALineId', 'SPAR_Low',
    'SDKLDefaultLocation', 'SFTSREngine', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SVGetAudioInputs', 'SVP_19', 'DISPID_SVSInputWordLength',
    'SVP_7', 'eLEXTYPE_USER_SHORTCUT', 'SPEI_END_SR_STREAM',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPANumberOfElementsInResult',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SVSCurrentStreamNumber', 'SVPNormal', 'SRADynamic',
    'SVP_20', 'DISPID_SVEventInterests', 'SpInprocRecognizer',
    'ISpEventSink', 'SpeechCategoryRecognizers', 'SpFileStream',
    'eLEXTYPE_RESERVED10', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPEAudioSizeBytes', 'SRSInactiveWithPurge', 'SGDSActive',
    'SGDSActiveUserDelimited', 'ISpeechPhraseRule',
    'DISPID_SGRAddState', 'STCLocalServer', 'SVSFNLPMask',
    'SAFT11kHz16BitStereo', 'SRERecoOtherContext',
    'ISpSerializeState', 'SAFT11kHz8BitMono', 'SP_VISEME_4',
    'SPAR_Unknown', 'SpeechPartOfSpeech', 'ISpeechGrammarRuleState',
    'SVSFPurgeBeforeSpeak', 'DISPID_SVGetVoices',
    'DISPID_SVIsUISupported', 'SpShortcut', 'SSFMOpenForRead',
    'SGDisplay', 'SPSHT_EMAIL', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechLexiconProns', 'SPEI_PHRASE_START', 'SRCS_Enabled'
]

_check_version('1.1.14', 1636565778.668034)
